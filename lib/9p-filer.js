...
Virtio9p.prototype.shouldAbortRequest = function(tag) {
    ...
    if(shouldAbort) {
        console.log("Request can be aborted tag=" + tag);
    }
    return shouldAbort;
};

Virtio9p.prototype.SendReply = function(x, y) {
    console.log("Unexpected call to SendReply on Virtio9p", x, y);
};
...
Virtio9p.prototype.BuildReply = function(id, tag, payloadsize) {
    ...
    if ((payloadsize+7) >= this.replybuffer.length) {
        console.log("Error in 9p: payloadsize exceeds maximum length");
    }
...
Virtio9p.prototype.ReceiveRequest = function (index, GetByte) {
    ...
    switch(id) {
        ...
        case P9_TLOPEN:
            ...
            console.log("[tlopen] fid=" + fid, " path=" + path, " mode=" + mode);
        ...
        case P9_TLINK:
            ...
            console.log("[link] existingPath=" + existingPath + ", newPath=" + newPath);
        ...
        case P9_TSYMLINK:
            ...
            console.log("[symlink] symtgt=" + symtgt +", newPath=" + newPath + ", gid=" + gid); 
        ...
        case P9_TMKNOD:
            ...
            var minor = req[4];
            var gid = req[5];
            console.log("[mknod] filePath=" + filePath + ", major=" + major + ", minor=" + minor + ", gid=" + gid);
        ...
        case P9_TREADLINK:
            ...
            console.log("[readlink] path=" + path);
        ...
        case P9_TMKDIR:
            ...
            console.log("[mkdir] fid.path=" + parentPath + ", name=" + newDir + ", mode=" + mode + ", gid=" + gid);
        ...
        case P9_TLCREATE:
            ...
            var mode = req[3];
            var gid = req[4];
            console.log("[tlcreate] fid=" + fid + ", name=" + name + ", mode=" + mode + ", gid=" + gid);
        ...
        */
        ...
        case P9_TGETATTR:
            ...
            console.log("[getattr]: fid=" + fid + " path=" + path + " request mask=" + req[1]);
            ...
            fs.lstat(path, function (err, stats) {
                ...
                console.log('stats', {mode: stats.mode, stats: stats, p9Stats: p9Stats });
        ...
        case P9_TSETATTR:
            ...
            console.log("[setattr]: path=" + path + " request mask=" + req[1]);
            ...
            if ((req[1] & P9_SETATTR_UID) && (req[1] & P9_SETATTR_GID)) {
                promises.push(
                    new Promise(function(resolve, reject) {
                        ...
                        console.log("[setattr]: uid=" + uid + " gid=" + gid);
            ...
            if (req[1] & P9_SETATTR_CTIME) {
                console.warn('[TODO] requested to SETATTR for CTIME, ignoring');
            }
            ...
            if(atime || mtime) {
                promises.push(
                    new Promise(function(resolve, reject) {
                        ...
                        console.log("[setattr]: atime=" + atime + " mtime=" + mtime);
        ...
        case P9_TREADDIR:
            ...
            console.log("[treaddir]: fid=" + fid + " path=" + path + " offset=" + offset + " count=" + count);
        ...
        case P9_TREAD:
            ...
            console.log("[tread]: fid=" + fid + " path=" + path + " offset=" + offset + " count=" + count);
 ...
 */
        ...
        case P9_TWRITE:
            ...
            console.log("[twrite]: fid=" + fid + " path=" + path + " offset=" + offset + " count=" + count);
        ...
        case P9_TRENAMEAT:
            ...
            console.log("[renameat]: oldPath=" + oldPath + " newPath=" + newPath);
        ...
        case P9_TUNLINKAT:
            ...
            console.log("[tunlinkat]: path=" + path);
        ...
        case P9_TVERSION:
            ...
            console.log("[version]: msize=" + version[0] + " version=" + version[1]);
        ...
        case P9_TATTACH: // attach - size[4] Tattach tag[2] fid[4] afid[4] uname[s] aname[s]
            ...
            var fid = req[0];
            var uid = req[4];
            console.log("[attach]: fid=" + fid + " afid=" + hex8(req[1]) + " uname=" + req[2] + " aname=" + req[3]);
        ...
        case P9_TWALK:
            ...
            var offset = 7+2;
            var nwidx = 0;
            console.log("walk in dir " + path  + " to: " + walk.toString());
...
*/
        ...
        case P9_TCLUNK:
            ...
            console.log("[clunk]: fid=" + fid + " path=" + path);
        ...
        case P9_TXATTRCREATE:
            ...
            var attr_size = req[2];
            var flags = req[3];
            console.log("[txattrcreate]: fid=" + fid + " name=" + name + " attr_size=" + attr_size + " flags=" + flags);
            this.BuildReply(id, tag, 0);
            this.SendReply(0, index);
        ...
        case P9_TXATTRWALK:
            ...
            var newfid = req[1];
            var name = req[2];
            console.log("[xattrwalk]: fid=" + req[0] + " newfid=" + req[1] + " name=" + req[2]);
        ...
        default:
            console.log("Error in Virtio9p: Unknown id " + id + " received");
            message.Abort();
